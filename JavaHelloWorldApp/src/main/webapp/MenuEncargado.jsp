  ...
  <nav class="nav" role="navigation">
    <ul class="nav__list">
      <li>
        ...
        <label for="group-1"><span class="fa fa-angle-right"></span>Exepciones de Servicio</label>
        <ul class="group-list">
          <li><a href="RegistrarExcepcionServicio.jsp">Agregar Exepción</a></li>
          <li><a href="VerExcepciones.jsp">Consultar Exepciones</a></li>
          <li><a href="EditarExcepcion.jsp">Editar Exepción</a></li>
          <li><a href="EliminarExcepcion.jsp">Eliminar Exepción</a></li>
        </ul>
      </li>
      <li>
        ...
        <ul class="group-list">
          <li><a href="ConsultarCalificaciones.jsp">Consultar Calificaciones de salas</a></li>
        </ul>
      </li>
      <li>
	...
	<li>
        ...
        <label for="group-7"><span class="fa fa-angle-right"></span>Análisis de tonos</label>
        <ul class="group-list">
          <li><a href="ConsultarEmociones.jsp">Consultar Emociones </a></li>
          <li><a href="ConsultarEstiloLenguaje.jsp">Consultar Estilo de lenguaje</a></li>
          <li><a href="ConsultarTendenciasSociales.jsp">Consultar tendecias sociales</a></li>
        </ul>
      </li>
		<li>
        ...
        <ul class="group-list">
          <li><a href="RegistrarMantenimiento.jsp">Registrar Mantenimiento de Sala </a></li>
